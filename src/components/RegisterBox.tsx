...
import { getProfile, postLogin, postRegister, Role } from "../app/lib/auth";
...
export default function RegisterBox(){
      ...
      const [chooseRole, setChooseRole] = useState<Role>("User")
      ...
      const onSubmit : SubmitHandler<z.infer<typeof loginSchema>> = async (data) => {
        ...
        const response = await postRegister(data.username,data.password, chooseRole)
        if(response){
            console.log("ok selamat anda udah buat password")
        }
    ...
    return (
        ...
        <div className="flex flex-col w-full   gap-2">
          ...
          <Label htmlFor="role" className="px-1">
            ...
            <Select defaultValue={chooseRole} onValueChange={(role : Role) => setChooseRole(role)}>
